...
**ถามในกลุ่ม LINE ก็ได้เหมือนกัน** — แค่พิมพ์ขึ้นต้นด้วยคำว่า **"ถาม"** เช่น "ถาม รายรับวันนี้เท่าไหร่" (ต้องเป็นกลุ่มที่เชื่อมกับร้านไว้แล้วผ่านหน้าตั้งค่า) กำหนดให้ต้องขึ้นต้นด้วย "ถาม" เพื่อไม่ให้บอทตอบทุกข้อความที่คนในกลุ่มคุยกันเอง
