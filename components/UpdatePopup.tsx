...
const LATEST_UPDATE: UpdateInfo = {
  ...
  features: [
    {
      icon: '🐛',
      title: 'แก้บัค: สแกนขายไม่ติด',
      desc: 'แก้ปัญหาตอนสแกนเร็วๆ ของหายไปจากตะกร้า',
    },
    {
      icon: '🔒',
      title: 'Staff แก้ไขสต๊อกของไม่ได้',
      desc: 'ปุ่มแก้ไขจะไม่โผล่ให้พนักงาน - ป้องกันแก้ราคาผิด',
    },
    {
      icon: '📷',
      title: 'ปุ่มสแกนต่อ',
      desc: 'หลังเพิ่มของในตะกร้า มีปุ่ม "สแกนต่อ" เด่นๆ ทำงานเร็วขึ้น + สั่นแจ้งเตือน',
    },
  ],
};
